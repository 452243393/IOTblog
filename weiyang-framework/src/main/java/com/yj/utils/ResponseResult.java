...
public class ResponseResult<T> implements Serializable {
    ...
    public static ResponseResult successResult(Integer code,String msg){
        ResponseResult result = new ResponseResult();
        return result.success(code,msg);
    }
    public static ResponseResult successResult(Object data){
        ResponseResult result = setAppHttpCodeEnum(AppHttpCodeEnum.SUCCESS,AppHttpCodeEnum.SUCCESS.msg);
        if(data!=null){
            result.setData(data);
        }
        return result;
